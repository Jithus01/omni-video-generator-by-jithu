      ...
      <div className="relative bg-black rounded-xl overflow-hidden shadow-2xl flex-grow flex items-center justify-center">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent">
          ...
          <div className="flex justify-center items-center text-white space-x-6">
            ...
            <button onClick={handleRewind} title="Rewind 5s" className="hover:text-[#FF6633]">
              <RotateCcw size={20} />
            </button>

            <button onClick={handlePlayPause} title={isPlaying ? "Pause" : "Play"} className="hover:text-[#FF6633]">
              {isPlaying ? <Pause size={22} /> : <Play size={22} />}
            </button>

            <button onClick={handleForward} title="Forward 5s" className="hover:text-[#FF6633]">
              <RotateCw size={20} />
            </button>
          </div>
        </div>
